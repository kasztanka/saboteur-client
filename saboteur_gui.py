...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout.addWidget(self.join_room, 5, 1, 1, 1)
        self.available_rooms = QtWidgets.QComboBox(self.centralwidget)
        self.available_rooms.setObjectName("available_rooms")
        self.gridLayout.addWidget(self.available_rooms, 5, 0, 1, 1)
        self.create_room = QtWidgets.QPushButton(self.centralwidget)
        self.create_room.setObjectName("create_room")
        self.gridLayout.addWidget(self.create_room, 3, 1, 1, 1)
        self.set_player_name = QtWidgets.QPushButton(self.centralwidget)
        self.set_player_name.setObjectName("set_player_name")
        self.gridLayout.addWidget(self.set_player_name, 2, 1, 1, 1)
        self.player_name = QtWidgets.QLineEdit(self.centralwidget)
        self.player_name.setObjectName("player_name")
        self.gridLayout.addWidget(self.player_name, 2, 0, 1, 1)
        self.room_name = QtWidgets.QLineEdit(self.centralwidget)
        self.room_name.setObjectName("room_name")
        self.gridLayout.addWidget(self.room_name, 3, 0, 1, 1)
        self.verticalLayout_3.addLayout(self.gridLayout)
        self.player_info = QtWidgets.QLabel(self.centralwidget)
        self.player_info.setMinimumSize(QtCore.QSize(0, 80))
        self.player_info.setText("")
        self.player_info.setObjectName("player_info")
        self.verticalLayout_3.addWidget(self.player_info)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.set_player_name.setText(_translate("MainWindow", "Ustaw nick"))
        self.player_name.setPlaceholderText(_translate("MainWindow", "Twój nick"))
        self.room_name.setPlaceholderText(_translate("MainWindow", "Nazwa"))
